...
(define-public python-sphinx-notfound-page
  (package
   ...
   (propagated-inputs (list python-sphinx-5.2
...
(define-public python-sphinx-autoapi
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "03y53cj4md8x4c9h58dwp5a4d9lh17q267f8r53aim8l8835hp2v"))))
    (build-system python-build-system)
    (arguments '(#:tests? #f))    
    (propagated-inputs (list python-astroid python-jinja2 python-pyyaml
                             python-sphinx-5.2 python-unidecode))
...
(define-public python-sphinxemoji
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0k2fh36fpv1ixc4n8pbd3x4gfqvjd2daq382cdg0ymy6swfiv1i7"))))
    (build-system python-build-system)
    (propagated-inputs (list python-sphinx))
    (home-page "https://github.com/sphinx-contrib/emojicodes")
...
(define-public python-imagesize
  (package
    ...
    (source
      ...
      (sha256
       (base32
        "178z4s971iwqh8a5i6lnngqfqabpki6vcicx8wks6p1qaba505yd"))))
    (build-system python-build-system)
...
(define-public python-sphinx-5.2
  (package
    (name "python-sphinx")
    (version "5.2.0")
    (source
     (origin
       ...
       (sha256
        (base32
         "0hi520nvabw94qg5qz5nhfwaim6c9v105lf9f5wgmp1pi44w540p"))))
    (build-system pyproject-build-system)
    (arguments
     '(#:phases
